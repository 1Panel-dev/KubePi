...
const message = {
    ...
    business: {
        ...
        user: {
            ...
            please_input_password_again: "please input password again",
...
const description = {
    ...
    i18n_user_manage_repo: "Image repositories administrators have all the permissions of the image repository objects.",
    ...
    i18n_manage_crd: "The custom resource administrator has all the permissions of the CustomResourceDefinition object",
