...
const message = {
  ...
  business: {
    ...
    node: {
      ...
      network_status_help: "Check if the network configuration on the node is available.",
      memory_status: "Memory Pressure",
      memory_status_help: "If the memory usage pressure on the node is too high, the scheduling fails.",
      disk_status: "Disk Pressure",
      disk_status_help: "If pressure exists on the disk size - that is, if the disk capacity is low.",
      pid_status: "PID Pressure",
      pid_status_help: "If pressure exists on the processes—that is, if there are too many processes on the node.",
      ...
      capacity: "Capacity",
      shell: "Shell",
      node_path_mounted: "node path / is mounted to shell /host",
    },
    pod: {
      image: "Image",
      eviction: "Eviction",
    ...
    workload: {
      ...
      suspend_deployment_confirm: "Suspend Deployments?",
      container: "Container",
    ...
    network: {
      ...
      hosts: "Hosts",
      add_host: "Add Host",
      search_ingress_placeholder: "Input URL to Search Ingresses",
      no_settings: "No Settings",
      tls_secret_empty: "The tls attribute is not null but no secrets",
    },
    storage: {
      provisioner: "Provisioner",
      persistent_volume_claims: "Persistent Volume Claims",
      persistent_volume_claim_create: "PersistentVolumeClaim Create",
      persistent_volume_claim_detail: "PersistentVolumeClaim Detail",
      persistent_volume_claim_edit: "PersistentVolumeClaim Edit",
      persistent_volumes: "Persistent Volumes",
      persistent_volume_create: "Persistent Volume Create",
      persistent_volume_edit: "Persistent Volume Edit",
      persistent_volume_detail: "Persistent Volume Detail",
      storage_classes: "Storage Classes",
      storage_class_create: "StorageClass Create",
      storage_class_edit: "StorageClass Edit",
      storage_class_detail: "StorageClass Detail",
    ...
    configuration: {
      ...
      api_service_edit: "APIService Edit",
      mutating_webhook_configurations: "Mutating Webhook Configurations",
      mutating_webhook_configuration_create: "MutatingWebhookConfiguration Create",
      mutating_webhook_configuration_edit: "MutatingWebhookConfiguration Edit",
      validating_webhook_configurations: "Validating Webhook Configurations",
      validating_webhook_configuration_create: "ValidatingWebhookConfiguration Create",
      validating_webhook_configuration_edit: "ValidatingWebhookConfiguration Edit",
