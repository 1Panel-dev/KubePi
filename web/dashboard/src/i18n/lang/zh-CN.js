...
const message = {
  commons: {
    ...
    personal: {
      ...
      star: "点亮 Star",
      version: "版本",
      copy_right: "Copyright © 2014-{year} 飞致云",
      one_panel_ad: "1Panel 团队出品",
    ...
    validate: {
      ...
      number_percent_rules: "请输入正确的正整数或百分比",
      name_rules: "仅支持小写英文、数字和-",
      url_rules: "请输入正确的 URL",
    ...
    confirm_message: {
      ...
      rollback: "此操作将回滚当前 Deployment 到该版本，是否继续？",
      change_to_download: "该文件超过 1 MB，直接打开将导致浏览器卡顿，是否下载？",
    },
    login: {
      username: "用户名",
      password: "密码",
    ...
    placeholder: {
      example_foo: "例如：foo",
      example_bar: "例如：bar",
      example_data_path: "例如：/data",
      example_nfs_path: "例如：/nfs-share",
      example_ip: "例如：172.16.10.100",
      example_cluster_ip: "例如：10.1.1.1",
      example_domain: "例如：example.com",
      example_database_domain: "例如：database.example.com",
      example_registry: "例如：some.docker.io",
      example_image: "例如：nginx:latest",
      example_1000: "例如：1000",
      example_128: "例如：128",
      example_8080: "例如：8080",
      example_80: "例如：80",
      example_command: "例如：/bin/sh",
      example_workdir: "例如：/myapp",
      example_health_path: "例如：/tmp/health",
      example_host: "例如：1.1.1.1",
      example_company_domain: "例如：mycompany.com",
      example_searches: "例如：foo.com,bar.com",
      example_key: "例如：key",
      example_value: "例如：value",
      example_zone: "例如：failure-domain.beta.kubernetes.io/zone",
      hostname: "hostname",
      subdomain: "subdomain",
      default_10: "默认：10",
      default_0: "默认：0",
  ...
  business: {
    common: {
      ...
      cpu: "CPU",
      memory: "内存",
      prometheus_sources: "Prometheus 来源",
      time_range_select: "时间范围",
      refresh_interval: "刷新间隔",
      half_hour_ago: "最近半小时",
      one_hour_ago: "最近 1 小时",
      twelve_hours_ago: "最近 12 小时",
      twenty_four_hours_ago: "最近 24 小时",
    ...
    dashboard: {
      ...
      metric_server_help: "未能检测到 Metrics Server 服务，点击安装或重置",
      metric_server_install_help: "Metrics Server 将在集群 kube-system 命名空间下创建以下内容：",
      has_permission: "已有权限",
    ...
    node: {
      ...
      kubeProxy_version: "kube-proxy 版本",
      drain_success: "排空节点成功",
      allocated: "已分配资源",
      health_status: "健康状态",
      network_status: "网络可用性",
      network_status_help: "检查节点上的网络配置是否正确。",
      memory_status: "内存压力 (MemoryPressure)",
      memory_status_help: "如果节点上的内存使用压力过大，则调度失败。",
      disk_status: "磁盘压力 (DiskPressure)",
      disk_status_help: "磁盘大小存在压力 - 即磁盘容量低。",
      pid_status: "进程压力 (PIDPressure)",
      pid_status_help: "如果节点进程压力过大，则会调度失败。",
      node_status: "节点就绪状态",
      node_status_help: "节点是否可以接收新的容器组。",
      usage: "用量",
      core: "核",
      taints: "污点",
      internal_ip: "内部 IP",
      ...
      capacity: "容量",
      shell: "Shell",
      node_path_mounted: "节点路径 / 已挂载到 Shell /host",
    },
    pod: {
      image: "镜像",
      eviction: "驱散",
      ...
      start_time: "开始时间",
      limit_byte: "最大限制",
      download_log_help: "将下载自 {0} 开始、最大 {1} MB 的日志文件。",
    ...
    workload: {
      ...
      resume: "激活 Resumed",
      deployment_processing: "Deployment 处理",
      suspend_deployment_confirm: "是否暂停 Deployment？",
      container: "容器",
      container_type: "容器类型",
      ...
      ip_address: "IP 地址",
      host_aliases: "主机别名",
      share_process_namespace_host_pid_conflict: "shareProcessNamespace 和 hostPID 不能同时为 true",
    ...
    network: {
      ...
      session_sticky_time: "会话保持时间",
      client_ip: "Client IP",
      seconds: "秒",
      ports: "端口",
      default_ingress_controller_certificate: "默认 Ingress Controller 证书",
      hosts: "主机",
      add_host: "添加主机",
      search_ingress_placeholder: "输入 URL 搜索 Ingress",
      no_settings: "No Settings",
      tls_secret_empty: "TLS 已设置但未配置 Secret",
    },
    storage: {
      provisioner: "提供商",
