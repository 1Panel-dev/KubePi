      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'CPU ' + $t('business.workload.reservation')" prop="requests.cpu">
            <ko-form-item :placeholder="$t('commons.placeholder.example_1000')" itemType="number" dividerName="mCPUs" v-model.number="form.requests.cpu" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$t('business.workload.memory') + $t('business.workload.reservation')" prop="requests.memory">
            <ko-form-item :placeholder="$t('commons.placeholder.example_128')" itemType="number" dividerName="Mi" v-model.number="form.requests.memory" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'CPU ' + $t('business.workload.limit')" prop="limits.cpu">
            <ko-form-item :placeholder="$t('commons.placeholder.example_1000')" itemType="number" dividerName="mCPUs" v-model.number="form.limits.cpu" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$t('business.workload.memory') + $t('business.workload.limit')" prop="limits.memory">
            <ko-form-item :placeholder="$t('commons.placeholder.example_128')" itemType="number" dividerName="Mi" v-model.number="form.limits.memory" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
