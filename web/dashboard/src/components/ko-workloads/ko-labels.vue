      ...
      <el-form :disabled="isReadOnly">
        <table style="width: 98%" class="tab-table">
          ...
          <tr v-for="(row, index) in labels" v-bind:key="index">
            <td>
              <ko-form-item :placeholder="$t('commons.placeholder.example_foo')" itemType="input" v-model="row.key" @change.native="transformation" />
            </td>
            <td>
              <ko-form-item :placeholder="$t('commons.placeholder.example_bar')" itemType="textarea" v-model="row.value" @change.native="transformation" />
            </td>
            <td>
