    ...
    <ko-card :title="$t('business.configuration.data')">
      <table style="width: 98%" class="tab-table">
        ...
        <tr v-for="label in data" v-bind:key="label.index">
          <td>
            <ko-form-item  :placeholder="$t('commons.placeholder.example_foo')" clearable itemType="input" v-model="label.key"
                          @change.native="transform"/>
          </td>
          <td>
            <ko-form-item  :placeholder="$t('commons.placeholder.example_bar')" clearable itemType="textarea"
