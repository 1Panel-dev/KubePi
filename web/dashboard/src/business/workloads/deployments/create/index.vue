    ...
    <div v-if="!showYaml">
      ...
      <el-tabs :key="isRefresh" style="margin-top: 30px;background-color: #141418;" type="border-card" v-model="activeName">
        ...
        <el-tab-pane label="Scaling/Upgrade Policy" name="Scaling/Upgrade Policy">
          <ko-upgrade-policy ref="ko_upgrade_policy" :upgradePolicyParentObj="form.spec" />
        </el-tab-pane>
...
export default {
  ...
  components: { LayoutContent, KoFormItem, KoBase, YamlEditor, KoContainer, KoPorts, KoCommand, KoResources, KoHealthCheck, KoSecurityContext, KoNetworking, KoPodScheduling, KoNodeScheduling, KoTolerations, KoUpgradePolicy, KoLabels, KoAnnotations, KoStorage },
  data() {
    return {
      // yaml
      showYaml: false,
