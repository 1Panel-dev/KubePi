...
export default {
  ...
  components: { LayoutContent, KoFormItem, YamlEditor, KoContainer, KoPorts, KoCommand, KoResources, KoHealthCheck, KoSecurityContext, KoNetworking, KoPodScheduling, KoNodeScheduling, KoTolerations, KoUpgradePolicyStatefulset, KoLabels, KoAnnotations, KoStorage },
  data() {
    return {
      showYaml: false,
      yaml: {},
