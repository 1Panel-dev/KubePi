<template>
  <layout-content :header="$t('commons.button.create')" :back-to="{ name: 'StatefulSets' }" v-loading="loading">
    <br>
    <div v-if="!showYaml">
...
export default {
  ...
  components: { LayoutContent, KoFormItem, KoBase, YamlEditor, KoContainer, KoPorts, KoCommand, KoResources, KoHealthCheck, KoSecurityContext, KoNetworking, KoPodScheduling, KoNodeScheduling, KoTolerations, KoUpgradePolicyStatefulset, KoLabels, KoAnnotations, KoStorage },
  data() {
    return {
      // yaml
      showYaml: false,
