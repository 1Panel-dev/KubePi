...
export default {
      ...
      buttons: [
        {
          ...
          icon: "el-icon-edit",
          click: (row) => {
            this.$router.push({ name: "StatefulSetEdit", params: { namespace: row.metadata.namespace, name: row.metadata.name }, query: { yamlShow: false } })
          },
        },
        {
          ...
          icon: "el-icon-edit",
          click: (row) => {
            this.$router.push({ name: "StatefulSetEdit", params: { namespace: row.metadata.namespace, name: row.metadata.name }, query: { yamlShow: true } })
          },
        },
        {
  ...
  methods: {
    onCreate() {
      this.$router.push({ name: "StatefulSetCreate", query: { yamlShow: false } })
    },
    openDetail(row) {
