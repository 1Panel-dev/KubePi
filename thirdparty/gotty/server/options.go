...
type Options struct {
	...
	TokenExpiresDuration int              `hcl:"token_expires_duration" flagName:"token-expires-duration" flagDescribe:"Seconds of duration for token expires" default:"300"`
...
type RedisOptions struct {
	...
	MinIdleConns int `hcl:"redis_min_idle_conns" flagName:"redis-min-idle-conns" flagDescribe:"redis minimum number of idle connections which is useful when establishing." default:"1"`
