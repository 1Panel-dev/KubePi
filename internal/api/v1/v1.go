...
import (
	...
	"errors"
	"fmt"
	"github.com/1Panel-dev/KubePi/internal/api/v1/monitor"
	"github.com/1Panel-dev/KubePi/internal/api/v1/proxy"
	"github.com/1Panel-dev/KubePi/internal/api/v1/sso"
	"io/ioutil"
	"strings"

	"github.com/1Panel-dev/KubePi/internal/api/v1/mfa"
	"github.com/1Panel-dev/KubePi/internal/server"

	"github.com/1Panel-dev/KubePi/internal/api/v1/file"
	"github.com/kataras/iris/v12/middleware/jwt"

	"github.com/1Panel-dev/KubePi/internal/api/v1/chart"
	"github.com/1Panel-dev/KubePi/internal/api/v1/cluster"
	"github.com/1Panel-dev/KubePi/internal/api/v1/imagerepo"
	"github.com/1Panel-dev/KubePi/internal/api/v1/ldap"
	"github.com/1Panel-dev/KubePi/internal/api/v1/role"
	"github.com/1Panel-dev/KubePi/internal/api/v1/session"
	"github.com/1Panel-dev/KubePi/internal/api/v1/system"
	"github.com/1Panel-dev/KubePi/internal/api/v1/user"
	"github.com/1Panel-dev/KubePi/internal/api/v1/webkubectl"
	"github.com/1Panel-dev/KubePi/internal/api/v1/ws"
	v1 "github.com/1Panel-dev/KubePi/internal/model/v1"
	v1Role "github.com/1Panel-dev/KubePi/internal/model/v1/role"
	v1System "github.com/1Panel-dev/KubePi/internal/model/v1/system"
	"github.com/1Panel-dev/KubePi/internal/service/v1/common"
	v1RoleService "github.com/1Panel-dev/KubePi/internal/service/v1/role"
...
var resourceWhiteList = WhiteList{"sessions", "proxy", "ws", "webkubectl", "mfa"}
