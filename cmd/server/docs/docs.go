                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api_v1_cluster.Member"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_v1_cluster.CreateRepo"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_v1_cluster.UpdateCluster"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_v1_imagerepo.RepoConfig"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_v1_session.LoginCredential"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "internal_api_v1_cluster.Cluster": {
            ...
            "properties": {
                ...
                "extraClusterInfo": {
                    "$ref": "#/definitions/internal_api_v1_cluster.ExtraClusterInfo"
                },
                "keyDataStr": {
                    "type": "string"
                },
        ...
        "internal_api_v1_cluster.CreateRepo": {
            "type": "object",
            "properties": {
                "cluster": {
                    "type": "string"
        ...
        "internal_api_v1_cluster.ExtraClusterInfo": {
            "type": "object",
            "properties": {
                "cpuAllocatable": {
                    "type": "number"
        ...
        "internal_api_v1_cluster.Member": {
            "type": "object",
            "properties": {
                "bindingName": {
                    "type": "string"
                ...
                "namespaceRoles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_v1_cluster.NamespaceRoles"
                    }
                }
            }
        },
        "internal_api_v1_cluster.NamespaceRoles": {
            "type": "object",
            "properties": {
                "namespace": {
                    "type": "string"
        ...
        "internal_api_v1_cluster.UpdateCluster": {
            "type": "object",
            "properties": {
                "apiServer": {
                    "type": "string"
        ...
        "internal_api_v1_imagerepo.RepoConfig": {
            "type": "object",
            "required": [
                "limit",
                "page"
        ...
        "internal_api_v1_session.LoginCredential": {
            "type": "object",
            "properties": {
                "authMethod": {
                    "type": "string"
